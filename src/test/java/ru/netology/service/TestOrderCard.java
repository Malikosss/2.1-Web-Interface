...
public class TestOrderCard {
    ...
    public void wrongEnglishName() {
        ...
        driver.findElement(By.cssSelector("[type=\"text\"]")).sendKeys("Ddvnjdfndf");
        driver.findElement(By.cssSelector("[type=\"tel\"]")).sendKeys("+79030248197");
        driver.findElement(By.className("checkbox__box")).click();
        driver.findElement(By.className("button__content")).click();
    ...
    public void wrongNameWithNumber() {
        ...
        driver.findElement(By.cssSelector("[type=\"text\"]")).sendKeys("Ричард 3");
        driver.findElement(By.cssSelector("[type=\"tel\"]")).sendKeys("+79030248197");
        driver.findElement(By.className("checkbox__box")).click();
        driver.findElement(By.className("button__content")).click();
    ...
    public void twoFail() {
        ...
        driver.findElement(By.cssSelector("[type=\"text\"]")).sendKeys("Afvbjhdbfh");
        driver.findElement(By.cssSelector("[type=\"tel\"]")).sendKeys("+79030");
        driver.findElement(By.className("button__content")).click();
